            ...
            if (
                ...
                if( !empty( $quick_links ) && is_array( $quick_links ) ){
                    ...
                    foreach ( $quick_links as $quick_key => $quick_link ) {
                        ...
                        if( $quick_key == 'pro_url' || $quick_key == 'pro_demo_url' ){
...
$config = array(
    ...
    'quick_links'                    => array(
        ...
        'pro_demo_url'  => array(
            'text' => __('View Pro Demo','business-consultr'),
            'url' => 'https://keonthemes.com/theme-demo/?id=MTI4NnxidXNpbmVzcy1jb25zdWx0ci1wcm98QnVzaW5lc3MgQ29uc3VsdHIgUHJv'
        ),
        'rate_url'  => array(
    ...
    'faq'      => array(
        'first' => array (
            ...
            'desc' => esc_html__( 'Business Consultr supports WooCommerce, Contact From 7 and Jetpack.','business-consultr' ),
            'is_new_tab' => true
        ),
    ),
    // Support content tab.
