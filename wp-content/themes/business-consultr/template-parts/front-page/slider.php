...
?>
	<section class="wrapper block-slider">
		...
		<div class="home-slider owl-carousel">
			...
			?>
					<div class="slide-item  animated fadeInRight delay-1s" style="background-image: url( <?php echo esc_url( $image ); ?> );">
					    				...
					    				<div class="slide-inner text-center">
					    					<div class="post-content-inner-wrap">
						    					...
						    					<header class="post-title ">
						    						<!--<h2 class="animated fadeInRight delay-2s"><?php the_title(); ?></h2> -->
						    					</header>
