				...
				<div class="row">
					...
					$class = 'col-xs-12 col-sm-12 col-md-12 ';
						if( has_post_thumbnail() ):
							$class = 'col-xs-12 col-sm-12 col-md-8 animated zoomIn delay-1s';
					?>
					<div class="col-xs-12 col-sm-12 col-md-4 animated zoomIn delay-1s">
					...
					<div class="<?php echo esc_attr( $class ); ?>">
						<div class="area-div content-outer">
							<div class="section-title-group">
								<h2 class="section-title main_title">
									<?php the_title();
							...
							<?php business_consultr_excerpt(185); ?>
